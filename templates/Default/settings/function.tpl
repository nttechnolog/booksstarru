...
<div class="plan"><h3>Значёк <p>Vip пользователя </p><span><img src="/templates/Likan/images/vip.png"></span></h3><a class="signup"></a><ul><li><b>Цена <font color=\"ff0000\">-1000 Голосов.</font> </b><br><b>Срок действия: <font color=\"ff0000\">Навсегда.</font></b></li></ul><br><div class="button_div fl_l {vip_offline}" style="margin-left: 73px;" id="vipok"><button onclick="settings.addvip(); return false" id="vipokd">Купить</button></div><br></div></div>
