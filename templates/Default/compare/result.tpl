	...
	<table width="560px">
	 <tr>
	  ...
	  <td width="20%" valign="top">
		<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="margin-top:10px;height:22px">
		 <div class="button_div_gray " style="margin-top:10px;text-align:center;"><button id="fast_buts_0" onClick="Compare.choose_send(0); return false;" style="width:100%">пропустить</button></div>
		</div>
	  </td>
