...
<div class="miniature_title fl_l apps_box_text">Создание заметки</div><a class="cursor_pointer fl_r" onClick="viiBox.clos('notes', 1)">Закрыть</a>
<div class="clear"></div>
...
<div>
<input type="text" placeholder="Введите название заметки" class="videos_input" style="width:586px" maxlength="65" id="title_n" />
