<body>
<div id=page_reg> 
<a href="/"> <img src="{theme}/images/register/register_logo.png" alt="LIKAN desing register"/> </a>
...
<input type="submit" onClick="reg.step1(); return false" id="reg_lnk" value="Следующий шаг >>>"/>
Пользовательское соглашение <input type="checkbox" maxlength="30" id="user_rules" style="margin-left:10px;" value="1" />
</div>


<div style="display:none;" id="step2">
<h1>Укажите Вашу дату рождения, пол и страну.</h1>
<label><select id="sex">
