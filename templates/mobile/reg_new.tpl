...
<input type="submit" onClick="reg.step1(); return false" id="reg_lnk" value="Следующий шаг >>>"/><br/>
 ...
 <div id="uLogin" data-ulogin="display=panel;theme=classic;optional=first_name,last_name;providers=vkontakte,odnoklassniki,mailru,facebook;hidden=other;redirect_uri=http%3A%2F%2Fbooksstar.ru%2Fauth.php;mobilebuttons=0;"></div>
