...
$(document).ready(function(){
	...
	$(window).scroll(function(){
		if($(document).height() - $(window).height() <= $(window).scrollTop()+($(document).height()/2-450)){
			groups.wall_page();
		}
	});
...
<div class="ava fl_r" style="width:200px;margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
...
<div class="profiewr" style="width:560px">
