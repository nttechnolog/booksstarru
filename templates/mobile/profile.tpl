{url_img}
  <style>
   @font-face {
    ...
    src: url(https://booksstar.ru/shrift/CormorantInfant-Bold.ttf); /* Путь к файлу со шрифтом */
   }
   h8 {
...
<a class="fm_img_border" href="/editmypage" onClick="Page.Go(this.href); $('.profileMenu').hide(); return false;"><img onmouseover="myhtml.title('104', 'Редактировать страницу',https://booksstar.ru 'newBBlock1')" id="newBBlock1104" width="16" src="{theme}/images/icons/editmypages.png" /></a>
...
[obshenie]<div class="newmesnobg">
 <div style="margin: 20px 0; position: relative">
                <img src="https://booksstar.ru/uploads/gifts/hochuob.png" style="position: absolute; bottom: -50px; left: -30px">
              
            </div>
   <h4 style="color:#6D6D6D; text-align: center; margin-top: 10px;">Автор приглашает</h4><p><div style="text-align: center"><br>{avatar_obshenie} <br><b>{name_obshenie}</b><br></br><p style="color: gray;">{avtor_country}, {avtor_city}</p><br>{text}<br><p style="margin-top: 20px;"><a href="#" onclick="Page.Go('https://booksstar.ru//settings/function')">Хотите попасть сюда?</p></a><br></div></div></p>
 [/obshenie]
</br>
 ...
 <div class="newmesnobg" style="padding-right:0px;padding-left:5px"><font size="2">{notes}</font><div class="clear"></div>
    ...
    <font size="2"><div class="newmesnobg"><div class="albtitle"><font color="black" style="margin-left: 60px">Дуэлей: <font color="#256cb3">{duel_sum}</font></font> <a style="margin-left: 60px; href="#" onclick="Page.Go('/index.php?go=duel&act=table')">весь список</a></div><hr>
            ...
            <div style="margin: 20px 0; position: relative">
                <img src="https://booksstar.ru/uploads/gifts/1471506729.png" style="position: absolute; bottom: -5px; left: -30px">
                <center>
                <p>Жанр: {chanr}</p>
                </center>
            </div><hr>
...
<div class="fb-page" data-href="https://www.facebook.com/booksstar.ru" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/booksstar.ru" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/booksstar.ru">Писатели клуб Сообщество Стихи Рассказы Проза</a></blockquote></div>
 </center>
 </div>
 <br>
  <!-- Радио -->
