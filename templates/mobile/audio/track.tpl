<div class="audio_onetrack">
 ...
 [owner]<div class="audio_deletic cursor_pointer fl_r" onClick="audio.del('{aid}');location.reload();" onMouseOver="myhtml.title('{aid}', 'Удалить песню', 'dtrack_', 4)" id="dtrack_{aid}"></div>
