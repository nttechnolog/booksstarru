<div class="page_bg border_radius_5 margin_top_10" id="asnwe_{id}">
...
<div class="walltext">
 <div style="padding-left:2px">
  {answer}
  <br /><span class="color777">{date} [owner]<a href="/" class="fl_r" onClick="support.delanswe('{id}'); return false">Удалить</a>[/owner]</span>
 </div>
</div>
</div>
<div class="clear"></div>
