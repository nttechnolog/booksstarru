...
<div class="ewllfs"><a href="/u{user-id}"><img src="{ava}" width="40" height="40" align="left" /></a></div>
<div class="wallwTEXT">
<a href="/u{user-id}"><b>{name}</b></a> {online}<br />
<div>{text}</div>
<div class="clr"></div>
...
<div class="panelsuvd"><a href="/" id="wall_like_link{rec-id}" onClick="{like-js-function}; return false" class="{yes-like-color}">Мне нравится</a>[owner] - 
<a href="/" class="size10 fl_r" id="fast_del_{comm-id}" onclick="wall.fast_comm_del('{rec-id}');  return false" style="font-weight:normal;font-size:11px">Удалить</a>[/owner]</div>
