...
<TD colSpan="3">
<DIV id="line"></DIV>
<div style="MARGIN-LEFT: 5px"><blockquote>{text}</blockquote></div>

<div class="clear"></div>
<div class="size10 infowalltext_f clear">
  <div class="fl_l">[privacy-comment][comments-link]<span id="fast_comm_link_{rec-id}" class="fast_comm_link"><a href="/" id="fast_link_{rec-id}" onClick="wall.open_fast_form('{rec-id}'); wall.fast_open_textarea('{rec-id}'); return false">Написать рецензию</a></span>[/comments-link][/privacy-comment]</div>
...
[comment-form]<div class="wall_fast_opened_form" id="fast_form">
 <input type="text" class="wall_inpst fast_form_width wall_fast_input" value="написать рецензию..." id="fast_inpt_{rec-id}" onMouseDown="wall.fast_open_textarea('{rec-id}', 2); return false" style="margin:0px" />
 <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
