...
<div class="fm_item_info"><center>Сделайте внешний вид удобным, и привлекательным, для вас и других. Поддерживаются форматы JPG, PNG и GIF.<br /> -  Если у вас имеется фон, то вы можете его убрать. <br /><a class="cursor_pointer" onClick="fon_facemy.del('{id}')"><b>Очистить облик</b></a></center>
...
<div class="fon_facemy_add"><div class="fon_facemy_hidden" style="float:left;margin-right:10px; color: #4682B4;" onClick="fon_facemy.reload_facemy('{id}')">Просмотреть</div>

<div id="upload_fon_facemy" style="float:left; color: #4682B4;">Добавить фон</div>
