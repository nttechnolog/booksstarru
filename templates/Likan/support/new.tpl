...
Здесь Вы можете сообщить нам о любой проблеме, связанной с <b>нашим сайтом</b>.<br>
<input type="text" 
	class="videos_input" 
	style="width:805px;margin-top:10px;color:#c1cad0" 
	maxlength="65" 
	id="title"
...
<textarea 
	...
	id="question" 
	style="width:805px;height:100px;color:#c1cad0"
