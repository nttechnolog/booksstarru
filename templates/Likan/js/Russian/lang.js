...
lang_del_comm					= 'Рецензия успешно удалена.';
...
lang_notes_comm_max				= 'Ваша рецензия слишком длинная.';
...
lang_wall_del_com_ok			= '<div class="online" style="margin-bottom:10px">Рецензия успешно удалена.</div>';
lang_wall_all_lnk				= 'к предыдущим записям';
lang_wall_hide_comm				= 'Скрыть рецензии';
