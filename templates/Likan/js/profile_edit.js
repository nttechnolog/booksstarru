...
$(document).ready(function(){
	...
	$("#saveform").click(function(){
		...
		$.post('/index.php?go=editprofile&act=save_general', {sex: sex, day: day, month: month, year: year, country: country, city: city, sp: sp, sp_val: sp_val, type_profile: type_profile}, function(data){
			$('#info_save').hide();
			if(data == 'ok'){
				$('#info_save').show();
