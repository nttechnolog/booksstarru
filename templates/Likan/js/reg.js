//REG
function get_cookie_prox( cookie_name )
{
...
var reg = {
    rues: function(){
	  $('#user_photo').toggleClass('html_checked');
	  $('#err_rules').hide();
	},
	step1: function(){
		var name = $('#name').val();
		var lastname = $('#lastname').val();
		if(!$('#user_photo').hasClass('html_checked')){
			$('#err_rules').show().html("Нужно принять правила");
			alert("Нужно принять правила");
		}
	...
	send: function(sec_code){
		...
		var type=get_cookie_prox("istype");
		var user_genre=$("#user_genre").val();
